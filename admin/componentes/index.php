        ...
        <div class="menu-lateral active">
          <div class="manu-lateral-content">
            ...
            <div class="menu-acessos">
                <h6>Acessos</h6>
                <ul>
                  <li data-id="biblioteca" class="bibli"><i class="fas fa-book-open"></i><a href="#">Livros</a></li>
                  <li data-id="biblioteca" class="bibli"><i class="fas fa-book-open"></i><a href="#">Gêneros</a></li>
                  <li data-id="biblioteca" class="bibli"><i class="fas fa-book-open"></i><a href="#">Autores</a></li>
                </ul>
            </div>
          </div>
        </div>
